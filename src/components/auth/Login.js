  ...
  const form = type => {
    return (
      <form className="fr ml6 mv3 pa3 br2 shadow-1 w-70">
        <label className="cream dib f6 b db mb2" htmlFor="email">
          Email
        </label>
        <input
          ...
          placeholder=""
        />
        <label className="cream dib f6 b db mb2" htmlFor="password">
          Password
        </label>
        <input
          className="dib fr f7 w-70 pa1 outline-0"
      ...
      {isAuthenticated() ? (
        <Fragment>
          ...
          <h4 className="dib cream" onClick={handleLogout}>
            ...
            <a className="cream fw6 f6 pr1 dim pointer no-underline" href=".">
              Sign out
            </a>
          </h4>
        </Fragment>
        ...
        <Fragment>
          <div className="fr">
            ...
            <h4 className="dib dim pointer cream fw6 f6">Register</h4>
          </div>
